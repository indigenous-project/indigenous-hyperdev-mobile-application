...
const OrganizationDetailsTimeCard = (props) => {
  // get the opening hours of the organization
  const openHours = props.openHours;

  return (
    //to display the opening hours of each day on a week
    <View style={styles.timingCard}>
      ...
      <View style={{ flexDirection: 'row' }}>
        ...
        <Text style={styles.lineHeightMonday}>
          {/*using condition to prevent from showing undefined value */}
...
const styles = StyleSheet.create({
  //styling on Organization time view
  timingCard: {
